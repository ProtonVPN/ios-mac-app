...
public class ProfileConstants {
    ...
    public static let defaultProfiles = [ Profile(id: "st_f", accessTier: 0, profileIcon: .image("fastest"), profileType: .system,
                                           serverType: .unspecified, serverOffering: .fastest(nil), name: LocalizedString.fastest, vpnProtocol: PropertiesManager().vpnProtocol, netShieldType: nil),
                                          Profile(id: "st_r", accessTier: 0, profileIcon: .image("random"), profileType: .system,
                                           serverType: .unspecified, serverOffering: .random(nil), name: LocalizedString.random, vpnProtocol: PropertiesManager().vpnProtocol, netShieldType: nil) ]
