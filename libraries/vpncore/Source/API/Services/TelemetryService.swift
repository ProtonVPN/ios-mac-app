...
public class TelemetryServiceImplementation: TelemetryService {
    ...
    private func collectDimensionsAndReport(outcome: TelemetryDimensions.Outcome, eventType: ConnectionEventType?) throws {
    ...
    private func connectionEventType(state: ConnectionStatus) throws -> ConnectionEventType {
        switch state {
        case .connected:
    ...
    private func report(event: TelemetryEvent) throws {
