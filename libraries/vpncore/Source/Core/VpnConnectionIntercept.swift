...
public enum VpnConnectionInterceptResult {
    ...
    public struct InterceptParameters {
        ...
        /// Don't connect with Kill Switch enabled.
        public let disableKillSwitch: Bool

        public init(newProtocol: ConnectionProtocol, smartProtocolWithoutWireGuard: Bool, disableKillSwitch: Bool) {
            self.newProtocol = newProtocol
            self.smartProtocolWithoutWireGuard = smartProtocolWithoutWireGuard
            self.disableKillSwitch = disableKillSwitch
        }
    }
