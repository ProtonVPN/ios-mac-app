...
class VpnServerSelectorTests: XCTestCase {
    ...
    func testSelectsFastestOverall() throws {
        ...
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .fastest, vpnProtocol: .ike, netShieldType: .off, profileId: nil, allowVpnProtocolChange: nil)
    ...
    func testSelectsFastestInCountry() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("DE", .fastest), vpnProtocol: .ike, netShieldType: .off, profileId: nil, allowVpnProtocolChange: nil)
    ...
    func testSelectsServer() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("DE", .server(getServerModel(id: "DE2", countryCode: "DE", tier: 1, score: 6))), vpnProtocol: .ike, netShieldType: .off, profileId: nil, allowVpnProtocolChange: nil)
    ...
    func testReturnsNilForEmptyCountry() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("FR", .random), vpnProtocol: .ike, netShieldType: .off, profileId: nil, allowVpnProtocolChange: nil)
    ...
    func testDoesntReturnServerUnderMaintenance() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("GB", .random), vpnProtocol: .ike, netShieldType: .off, profileId: nil, allowVpnProtocolChange: nil)
    ...
    func testChangesActiveServerType() throws {
        let currentUserTier = 1
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .secureCore, connectionType: .fastest, vpnProtocol: .ike, netShieldType: .off, profileId: nil, allowVpnProtocolChange: nil)
