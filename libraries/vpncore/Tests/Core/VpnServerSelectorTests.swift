...
class VpnServerSelectorTests: XCTestCase {
    ...
    func testSelectsFastestOverall() throws {
        ...
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .fastest, connectionProtocol: .vpnProtocol(.ike), netShieldType: .off, profileId: nil)
    ...
    func testSelectsFastestInCountry() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("DE", .fastest), connectionProtocol: .vpnProtocol(.ike), netShieldType: .off, profileId: nil)
    ...
    func testSelectsServer() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("DE", .server(getServerModel(id: "DE2", countryCode: "DE", tier: 1, score: 6))), connectionProtocol: .vpnProtocol(.ike), netShieldType: .off, profileId: nil)
    ...
    func testReturnsNilForEmptyCountry() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("FR", .random), connectionProtocol: .vpnProtocol(.ike), netShieldType: .off, profileId: nil)
    ...
    func testDoesntReturnServerUnderMaintenance() throws {
        let currentUserTier = 3
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .unspecified, connectionType: .country("GB", .random), connectionProtocol: .vpnProtocol(.ike), netShieldType: .off, profileId: nil)
    ...
    func testChangesActiveServerType() throws {
        let currentUserTier = 1
        let type = ServerType.unspecified
        let connectionRequest = ConnectionRequest(serverType: .secureCore, connectionType: .fastest, connectionProtocol: .vpnProtocol(.ike), netShieldType: .off, profileId: nil)
