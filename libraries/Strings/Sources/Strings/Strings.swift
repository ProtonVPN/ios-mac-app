...
public enum Localizable {
  ...
  /// Body of the deprecated protocol alert on iOS. Shown when the user attemps to connect to a profile with OpenVPN or IKEv2. Edit profiles is emphasized with quotation marks, which must be escaped with the backslash (\).
  public static var alertProtocolDeprecatedBodyIos: String { return Localizable.tr("Localizable", "_alert_protocol_deprecated_body_ios", fallback: "We found a security issue that affects IKEv2 and OpenVPN on iOS devices. To ensure a secure browsing experience for the Proton community, we removed these protocols.\n\nTo connect, enable Smart Protocol or go to \"Edit Profiles\" to select another protocol.") }
  /// Body of the deprecated protocol alert on MacOS. Shown when the user attemps to connect to a profile with OpenVPN. Manage profiles is emphasized with quotation marks, which must be escaped with the backslash (\). The 'Learn more' text is a hyperlink to https://protonvpn.com/blog/remove-vpn-protocols-apple
  public static var alertProtocolDeprecatedBodyMacos: String { return Localizable.tr("Localizable", "_alert_protocol_deprecated_body_macos", fallback: "We found a security issue that affects OpenVPN on macOS. To ensure a secure browsing experience for the Proton community, we removed this protocol.\nTo connect, enable Smart Protocol or go to \"Manage profiles\" to select another protocol. Learn more") }
  ...
  public static var alertProtocolDeprecatedEnableSmart: String { return Localizable.tr("Localizable", "_alert_protocol_deprecated_enable_smart", fallback: "Enable Smart protocol") }
